...
## System Architecture
Angular communicates with ASP.NET Core Web API over REST through a typed HttpClient service. The API uses JWT for identity, EF Core for data access, and SQL Server for persistence.

## Frontend Architecture
The frontend uses Angular standalone components, Angular Router, signals, typed services, route guards, and Reactive Forms validation. Shared components and CSS animations provide the scroll-based visual experience.
